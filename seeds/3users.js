exports.seed = function(knex, Promise) {
  return knex('users').del()
    .then(function () {
      return Promise.all([
        knex('users').insert({ googleId: 'q8948yggrwetwhtrrhur779sdf3', first_name: 'Nathan', last_name: 'Ostiguy', email: 'peterjostiguy@gmail.com', permission: false, birthday: '1987-10-11', diagnosis_id: 1, medicine_id: 2, telephone: '515-229-1737' }),
